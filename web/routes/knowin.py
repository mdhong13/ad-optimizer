...
# 자동 게시 Worker API 제거됨 (2026-06-02) — 셀렉터 디버그 부담으로 자동 게시 보류,
# 일 5건 수동 게시로 운영. 관련 UI (post-queue 카드·자동게시큐 버튼·폴링) 도 제거.
# 로컬 worker 스크립트는 worker/knowin_auto_poster.py 에 잔존 (웹앱 비의존).
