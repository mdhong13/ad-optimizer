...
# 이력: 0.55 (운영) → 0.60 (2026-05-31 실험) → 0.55 복귀 (2026-06-02)
# 0.60 실험은 회귀였음: dense v1 인덱스에서 정상 truck-wiki 매칭이 0.55~0.60 구간에
# 깔림 (실측: 녹스센서 위키 0.555, 채택 답변 조기폐차 0.594). 0.60 컷이 정상 매칭을
# 대량 rejected 처리 → "매칭 모두 실패" 사고. 검증된 0.55 로 복귀.
